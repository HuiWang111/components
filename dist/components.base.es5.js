;!function (win, $, Swiper, Component, Util) {
  ...
  var isString = Util.isString,
      ...
      isObjectLike = Util.isObjectLike,
      ...
      getRandomClassName = Util.getRandomClassName;
  ...
  var iconTypes = ['warn', 'success', 'info', 'error', 'close', 'loading', 'confirm'];
  var themes = ['outline', 'filled'];
  ...
  Object.assign(Tabs.prototype, {
    render: function render() {
      var $container = this.$container,
          ...
          tabPanes = _options3.tabPanes,
          renderPaneItem = _options3.renderPaneItem,
          defaultKey = _options3.defaultKey,
          type = _options3.type,
          editable = _options3.editable;
    ...
    handleTabChange: function handleTabChange(current, index, isOnClose) {
      ...
      var unRenderPanes = this.unRenderPanes,
          ...
          type = _options4.type,
          onChange = _options4.onChange,
          tabPanes = _options4.tabPanes;
      var $tabItems = this.$tabItems;
      ...
      if (type === 'line') {
        ...
        $underline.translateX(function () {
          var i = void 0,
              distance = 0;
          for (i = 0; i < index; i++) {
            distance += _this.tabItemsWidthList[i] + TAB_ITEM_GAP;
          }
          return distance;
        });
      }
  ...
  Object.assign(Pagination.prototype, {
    render: function render() {
      var selector = this.selector,
          ...
          current = _options5.current,
          total = _options5.total,
          pageSize = _options5.pageSize;
    ...
    createPagination: function createPagination(page, isActive) {
      var _options6 = this.options,
          ...
          itemRender = _options6.itemRender;
   ...
   */
  // className
  var TEXTCLASS = 'cpts-message-text-box';
  var CONTAINERCLASS = 'cpts-message-contaier';
  var ICONCLASS = 'cpts-message-icon';
  ...
  Object.assign(Message.prototype, {
    render: function render() {
      ...
      var klass = appendClass(CONTAINERCLASS, RANDOM_CLASS, classPrefix + 'container');
    ...
    show: function show(content, duration, onClose) {
      ...
      setTimeout(function () {
        ...
        var index = messageList.indexOf(_this2);
        $el.css({
  ...
  var GALLERY_BUTTON_PREV_CLASS = 'cpts-gallery-swiper-button-prev';
  var GALLERY_PAGINATION_CLASS = 'cpts-gallery-swiper-pagination';
  var GALLERY_SWIPER_CONTAINER_CLASS = 'cpts-gallery-swiper-container';
  var GALLERY_WRAPPER_CLASS = 'cpts-gallery-wrapper';
  var GALLERY_CONTAINER_CLASS = 'cpts-gallery-contaier';
  var GALLERY_CONTAINER_CLASS_HIDDEN = 'cpts-gallery-contaier-invisible';
  ...
  Object.assign(Gallery.prototype, {
    ...
    render: function render() {
      ...
      var RANDOM_CLASS = this.RANDOM_CLASS,
          _options9 = this.options,
          pagination = _options9.pagination,
    ...
    style: function style() {
      ...
      var _options10 = this.options,
          ...
          height = _options10.height,
          bgColor = _options10.bgColor,
    ...
    swiperOptionsHandler: function swiperOptionsHandler() {
      var RANDOM_CLASS = this.RANDOM_CLASS,
          ...
          swiperOptions = _options11.swiperOptions,
          pagination = _options11.pagination,
          navgation = _options11.navgation;
  ...
  Object.assign(CardList.prototype, {
    render: function render() {
      var _options12 = this.options,
          ...
          renderItem = _options12.renderItem,
          lineItemNumber = _options12.lineItemNumber;
      var $container = this.$container;
    ...
    style: function style() {
      var $container = this.$container,
          _options13 = this.options,
          ratio = _options13.ratio,
          border = _options13.border;
  ...
  Object.assign(Alert.prototype, {
    render: function render() {
      var type = this.type,
          ...
          closable = _options14.closable,
          closeText = _options14.closeText,
          showIcon = _options14.showIcon,
          description = _options14.description,
          message = _options14.message,
          defaultVisible = _options14.defaultVisible,
          style = _options14.style;
    ...
    bindEvents: function bindEvents() {
      var _options15 = this.options,
          onClose = _options15.onClose,
          closable = _options15.closable;
    ...
    hide: function hide() {
      var $alertContainer = this.$alertContainer,
          ...
          _options16 = this.options,
          afterClose = _options16.afterClose,
          defaultVisible = _options16.defaultVisible;
  ...
  Object.assign(Modal.prototype, {
    render: function render() {
      var _options17 = this.options,
          ...
          closable = _options17.closable,
          bodyContent = _options17.bodyContent,
          footer = _options17.footer,
          bodyStyle = _options17.bodyStyle,
          centered = _options17.centered,
          style = _options17.style,
          wrapClassName = _options17.wrapClassName,
          zIndex = _options17.zIndex,
          defaultVisible = _options17.defaultVisible;
    ...
    bindEvents: function bindEvents() {
      var isModalClosable = this.isModalClosable,
          ...
          afterClose = _options18.afterClose,
          onCancel = _options18.onCancel,
          onOk = _options18.onOk,
          keyboard = _options18.keyboard;
    ...
    handleMask: function handleMask(dom) {
      var _options19 = this.options,
          maskStyle = _options19.maskStyle,
          mask = _options19.mask,
          centered = _options19.centered,
          defaultVisible = _options19.defaultVisible;
  ...
  var MODAL_TYPE_MAP = ['info', 'warn', 'error', 'success', 'confirm'];
  var MODAL_COMMON_TYPE_MAP = ['info', 'warn', 'error', 'success'];
