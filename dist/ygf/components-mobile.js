...
;!function (global, factory) {
  ...
  var Swiper = global.Swiper,
      ...
      toSelector = _global$util.toSelector,
      tagOf = _global$util.tagOf,
      extend = _global$util.extend,
      toArray = _global$util.toArray,
      toNumber = _global$util.toNumber,
      appendClass = _global$util.appendClass,
      getRandomClassName = _global$util.getRandomClassName,
      propsChecker = _global$util.propsChecker,
      _global$ClassName = global.ClassName,
      GALLERY_BUTTON_NEXT_CLASS = _global$ClassName.GALLERY_BUTTON_NEXT_CLASS,
      GALLERY_BUTTON_PREV_CLASS = _global$ClassName.GALLERY_BUTTON_PREV_CLASS,
      GALLERY_PAGINATION_CLASS = _global$ClassName.GALLERY_PAGINATION_CLASS,
      GALLERY_SWIPER_CONTAINER_CLASS = _global$ClassName.GALLERY_SWIPER_CONTAINER_CLASS,
      GALLERY_WRAPPER_CLASS = _global$ClassName.GALLERY_WRAPPER_CLASS,
      GALLERY_CONTAINER_CLASS = _global$ClassName.GALLERY_CONTAINER_CLASS,
      GALLERY_CONTAINER_CLASS_HIDDEN = _global$ClassName.GALLERY_CONTAINER_CLASS_HIDDEN,
  ...
  extend(Gallery.prototype, {
    ...
    swiperPropsHandler: function swiperPropsHandler() {
      var RANDOM_CLASS = this.RANDOM_CLASS,
          _props3 = this.props,
          swiperProps = _props3.swiperProps,
...
;!function (global, factory) {
  ...
  var Component = global.Component,
      ...
      PAGINATION_ITEM_CLASS = _global$ClassName2.PAGINATION_ITEM_CLASS,
      PAGINATION_ITEM_CLASS_ACTIVE = _global$ClassName2.PAGINATION_ITEM_CLASS_ACTIVE,
      PAGINATION_ITEM_CLASS_BORDER = _global$ClassName2.PAGINATION_ITEM_CLASS_BORDER,
      PAGINATION_ITEM_CLASS_DISABLE = _global$ClassName2.PAGINATION_ITEM_CLASS_DISABLE,
      PAGINATION_ITEM_CLASS_PREV = _global$ClassName2.PAGINATION_ITEM_CLASS_PREV,
      PAGINATION_ITEM_CLASS_NEXT = _global$ClassName2.PAGINATION_ITEM_CLASS_NEXT,
      PAGINATION_CONTAINER_CLASS = _global$ClassName2.PAGINATION_CONTAINER_CLASS,
      PAGINATION_ITEM_MORE_CLASS = _global$ClassName2.PAGINATION_ITEM_MORE_CLASS,
      PAGINATION_ITEM_NEXT_MORE_CLASS = _global$ClassName2.PAGINATION_ITEM_NEXT_MORE_CLASS,
      PAGINATION_ITEM_PREV_MORE_CLASS = _global$ClassName2.PAGINATION_ITEM_PREV_MORE_CLASS,
      _global$SVG = global.SVG,
      getPrevSvg = _global$SVG.getPrevSvg,
      getNextSvg = _global$SVG.getNextSvg,
      getEllipsisSvg = _global$SVG.getEllipsisSvg,
      getDoublePrevArrowSvg = _global$SVG.getDoublePrevArrowSvg,
      getDoubleNextArrowSvg = _global$SVG.getDoubleNextArrowSvg,
...
;!function (global, factory) {
  ...
  var Component = global.Component,
      ...
      removeKeys = _global$util3.removeKeys,
      appendClass = _global$util3.appendClass,
      propsChecker = _global$util3.propsChecker,
      debounce = _global$util3.debounce,
      isEmpty = _global$util3.isEmpty,
      _global$ClassName3 = global.ClassName,
      TAB_ITEM_CLASS = _global$ClassName3.TAB_ITEM_CLASS,
      TAB_ITEM_CLASS_ACTIVE = _global$ClassName3.TAB_ITEM_CLASS_ACTIVE,
      TAB_ITEM_CARD_CLASS = _global$ClassName3.TAB_ITEM_CARD_CLASS,
      TAB_ITEM_WRAP_CLASS = _global$ClassName3.TAB_ITEM_WRAP_CLASS,
      TAB_ITEM_INNER_CLASS = _global$ClassName3.TAB_ITEM_INNER_CLASS,
      TAB_ITEM_CARD_INNER_CALSS = _global$ClassName3.TAB_ITEM_CARD_INNER_CALSS,
      TAB_ITEM_CONTAINER_CLASS = _global$ClassName3.TAB_ITEM_CONTAINER_CLASS,
      TAB_ITEM_CONTAINER_WITH_ARROW_CLASS = _global$ClassName3.TAB_ITEM_CONTAINER_WITH_ARROW_CLASS,
      PANE_ITEM_CLASS = _global$ClassName3.PANE_ITEM_CLASS,
      PANE_ITEM_CLASS_ACTIVE = _global$ClassName3.PANE_ITEM_CLASS_ACTIVE,
      PANE_ITEM_WRAP_CLASS = _global$ClassName3.PANE_ITEM_WRAP_CLASS,
      TAB_ARROW_CLASS = _global$ClassName3.TAB_ARROW_CLASS,
      TAB_ARROW_CLASS_DISABLE = _global$ClassName3.TAB_ARROW_CLASS_DISABLE,
      TAB_ARROW_CLASS_INVISIBLE = _global$ClassName3.TAB_ARROW_CLASS_INVISIBLE,
      TAB_PREVIOUS_ARROW_CLASS = _global$ClassName3.TAB_PREVIOUS_ARROW_CLASS,
      TAB_NEXT_ARROW_CLASS = _global$ClassName3.TAB_NEXT_ARROW_CLASS,
      TAB_CONTAINER_CLASS = _global$ClassName3.TAB_CONTAINER_CLASS,
      UNDERLINE_CLASS = _global$ClassName3.UNDERLINE_CLASS,
      TAB_ANIMATE_CLASS = _global$ClassName3.TAB_ANIMATE_CLASS,
      TAB_ITEM_CONTAINER_WRAP_CLASS = _global$ClassName3.TAB_ITEM_CONTAINER_WRAP_CLASS,
      TAB_ITEM_EXTRA_CLASS = _global$ClassName3.TAB_ITEM_EXTRA_CLASS,
      CLOSE_ICON_CLASS = _global$ClassName3.CLOSE_ICON_CLASS,
  ...
  extend(Tabs.prototype, {
    render: function render() {
      var $container = this.$container,
          _props8 = this.props,
          tabPanes = _props8.tabPanes,
          renderPaneItem = _props8.renderPaneItem,
          defaultKey = _props8.defaultKey,
          type = _props8.type,
          editable = _props8.editable,
          insertElementJQueryFunc = _props8.insertElementJQueryFunc,
          animated = _props8.animated;
    ...
    bindEvents: function bindEvents() {
      var $tabItems = this.$tabItems,
          ...
          $container = this.$container,
          _props9 = this.props,
          editable = _props9.editable,
          block = _props9.block,
          animated = _props9.animated;
