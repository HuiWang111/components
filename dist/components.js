...
;!function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && module !== 'undefined' ? module.exports = factory(global) : typeof define === 'function' && define.amd ? define([global], factory) : global.Alert = factory(global);
}(this, function (global) {
  var Component = global.Component,
      $ = global.jQuery,
      _global$util2 = global.util,
      isString = _global$util2.isString,
      isFunction = _global$util2.isFunction,
      toSelector = _global$util2.toSelector,
      tagOf = _global$util2.tagOf,
      extend = _global$util2.extend,
      removeKeys = _global$util2.removeKeys,
      ...
      ALERT_MESSAGE_CLASS = _global$ClassName2.ALERT_MESSAGE_CLASS,
      ALERT_DESCRIPTION_CLASS = _global$ClassName2.ALERT_DESCRIPTION_CLASS,
      ALERT_ICON_CLASS = _global$ClassName2.ALERT_ICON_CLASS,
      ALERT_CLOSE_ICON = _global$ClassName2.ALERT_CLOSE_ICON,
      ALERT_WARN_CLASS = _global$ClassName2.ALERT_WARN_CLASS,
      ALERT_SUCCESS_CLASS = _global$ClassName2.ALERT_SUCCESS_CLASS,
      ALERT_ERROR_CLASS = _global$ClassName2.ALERT_ERROR_CLASS,
      ALERT_INFO_CLASS = _global$ClassName2.ALERT_INFO_CLASS,
      ALERT_CONTAINER_CLASS = _global$ClassName2.ALERT_CONTAINER_CLASS,
      ALERT_WITH_ICON_CLASS = _global$ClassName2.ALERT_WITH_ICON_CLASS,
      ALERT_WITH_DESC_CLASS = _global$ClassName2.ALERT_WITH_DESC_CLASS,
      ALERT_WITH_CLOSE_CLASS = _global$ClassName2.ALERT_WITH_CLOSE_CLASS,
      ALERT_INVISIBLE_CLASS = _global$ClassName2.ALERT_INVISIBLE_CLASS,
      ALERT_SLIDEUP_CLASS = _global$ClassName2.ALERT_SLIDEUP_CLASS,
      ALERT_SLIDEDOWN_CLASS = _global$ClassName2.ALERT_SLIDEDOWN_CLASS,
  ...
  extend(Alert.prototype, {
    render: function render() {
      var type = this.type,
          ...
          closable = _options2.closable,
          closeText = _options2.closeText,
          showIcon = _options2.showIcon,
          description = _options2.description,
          message = _options2.message,
          defaultVisible = _options2.defaultVisible,
    ...
    bindEvents: function bindEvents() {
      var _options3 = this.options,
          onClose = _options3.onClose,
          closable = _options3.closable;
    ...
    show: function show() {
      var visible = this.visible,
          ...
          defaultVisible = this.options.defaultVisible;
    ...
    hide: function hide() {
      var $alertContainer = this.$alertContainer,
          ...
          afterClose = _options4.afterClose,
          defaultVisible = _options4.defaultVisible;
...
;!function (global, factory) {
  ...
  var $ = global.jQuery,
      ...
      isEmpty = _global$util3.isEmpty,
      isFunction = _global$util3.isFunction,
      isUndefined = _global$util3.isUndefined,
      toSelector = _global$util3.toSelector,
      extend = _global$util3.extend,
      removeKey = _global$util3.removeKey,
      ...
      DEFAULT_BTN_CLASS = _global$ClassName3.DEFAULT_BTN_CLASS,
      GHOST_BTN_CLASS = _global$ClassName3.GHOST_BTN_CLASS,
      PRIMARY_BTN_CLASS = _global$ClassName3.PRIMARY_BTN_CLASS,
      DANGER_BTN_CLASS = _global$ClassName3.DANGER_BTN_CLASS,
      DASHED_BTN_CLASS = _global$ClassName3.DASHED_BTN_CLASS,
      LINK_BTN_CLASS = _global$ClassName3.LINK_BTN_CLASS,
      CIRCLE_BTN_CLASS = _global$ClassName3.CIRCLE_BTN_CLASS,
      ROUND_BTN_CLASS = _global$ClassName3.ROUND_BTN_CLASS,
      LARGE_BTN_CLASS = _global$ClassName3.LARGE_BTN_CLASS,
      SMALL_BTN_CLASS = _global$ClassName3.SMALL_BTN_CLASS,
      BLOCK_BTN_CLASS = _global$ClassName3.BLOCK_BTN_CLASS,
      WITHICON_BTN_CLASS = _global$ClassName3.WITHICON_BTN_CLASS,
      LOADING_BTN_CLASS = _global$ClassName3.LOADING_BTN_CLASS,
      ICON_CLASS = _global$ClassName3.ICON_CLASS;
  ...
  extend(Button.prototype, {
    render: function render() {
      var $el = this.$el,
          ...
          type = _options5.type,
          shape = _options5.shape,
          ghost = _options5.ghost,
          disabled = _options5.disabled,
          iconType = _options5.iconType,
          iconOptions = _options5.iconOptions,
          block = _options5.block,
          className = _options5.className,
          htmlType = _options5.htmlType,
          size = _options5.size,
          text = _options5.text;
...
;!function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(global) : typeof define === 'function' && define.amd ? define([global], factory) : global.CardList = factory(global);
}(this, function (global) {
  var Component = global.Component,
      $ = global.jQuery,
      ...
      CARD_LIST_ITEM_INNER_CLASS = _global$ClassName4.CARD_LIST_ITEM_INNER_CLASS,
      CARD_LIST_ITEM_CLASS = _global$ClassName4.CARD_LIST_ITEM_CLASS;
...
;!function (global, factory) {
  ...
  var Swiper = global.Swiper,
      ...
      isNumber = _global$util5.isNumber,
      toSelector = _global$util5.toSelector,
      tagOf = _global$util5.tagOf,
      extend = _global$util5.extend,
      toArray = _global$util5.toArray,
      toNumber = _global$util5.toNumber,
      ...
      GALLERY_BUTTON_NEXT_CLASS = _global$ClassName5.GALLERY_BUTTON_NEXT_CLASS,
      GALLERY_BUTTON_PREV_CLASS = _global$ClassName5.GALLERY_BUTTON_PREV_CLASS,
      GALLERY_PAGINATION_CLASS = _global$ClassName5.GALLERY_PAGINATION_CLASS,
      GALLERY_SWIPER_CONTAINER_CLASS = _global$ClassName5.GALLERY_SWIPER_CONTAINER_CLASS,
      GALLERY_WRAPPER_CLASS = _global$ClassName5.GALLERY_WRAPPER_CLASS,
      GALLERY_CONTAINER_CLASS = _global$ClassName5.GALLERY_CONTAINER_CLASS,
      GALLERY_CONTAINER_CLASS_HIDDEN = _global$ClassName5.GALLERY_CONTAINER_CLASS_HIDDEN,
  ...
  extend(Gallery.prototype, {
    ...
    render: function render() {
      ...
      var RANDOM_CLASS = this.RANDOM_CLASS,
          _options8 = this.options,
          pagination = _options8.pagination,
          navgation = _options8.navgation;
    ...
    style: function style() {
      ...
      var _options9 = this.options,
          ...
          height = _options9.height,
          bgColor = _options9.bgColor,
          navgation = _options9.navgation;
    ...
    swiperOptionsHandler: function swiperOptionsHandler() {
      var RANDOM_CLASS = this.RANDOM_CLASS,
          ...
          swiperOptions = _options10.swiperOptions,
          pagination = _options10.pagination,
          navgation = _options10.navgation;
...
;!function (global, factory) {
  ...
  var Component = global.Component,
      ...
      SetMock = _global$util6.SetMock,
      appendClass = _global$util6.appendClass,
      getRandomClassName = _global$util6.getRandomClassName,
      _global$ClassName6 = global.ClassName,
      MESSAGE_TEXTCLASS = _global$ClassName6.MESSAGE_TEXTCLASS,
      MESSAGE_CONTAINERCLASS = _global$ClassName6.MESSAGE_CONTAINERCLASS,
      MESSAGE_ICONCLASS = _global$ClassName6.MESSAGE_ICONCLASS,
...
;!function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(global) : typeof define === 'function' && define.amd ? define([global], factory) : global.Modal = factory(global);
}(this, function (global) {
  var Component = global.Component,
      $ = global.jQuery,
      _global$util7 = global.util,
      isString = _global$util7.isString,
      isObject = _global$util7.isObject,
      isFunction = _global$util7.isFunction,
      isUndefined = _global$util7.isUndefined,
      isNull = _global$util7.isNull,
      toSelector = _global$util7.toSelector,
      extend = _global$util7.extend,
      removeUndef = _global$util7.removeUndef,
      appendClass = _global$util7.appendClass,
      getRandomClassName = _global$util7.getRandomClassName,
      _global$ClassName7 = global.ClassName,
      MODAL_FOOTER_CONTAINER_CLASS = _global$ClassName7.MODAL_FOOTER_CONTAINER_CLASS,
      MODAL_FOOTER_WRAP_CLASS = _global$ClassName7.MODAL_FOOTER_WRAP_CLASS,
      MODAL_FOOTER_OK_BTN_CLASS = _global$ClassName7.MODAL_FOOTER_OK_BTN_CLASS,
      MODAL_FOOTER_CANCEL_BTN_CLASS = _global$ClassName7.MODAL_FOOTER_CANCEL_BTN_CLASS,
      MODAL_HEADER_CONTAINER_CLASS = _global$ClassName7.MODAL_HEADER_CONTAINER_CLASS,
      MODAL_HEADER_WRAP_CLASS = _global$ClassName7.MODAL_HEADER_WRAP_CLASS,
      MODAL_CLOSE_ICON_CLASS = _global$ClassName7.MODAL_CLOSE_ICON_CLASS,
      MODAL_BODY_CLASS = _global$ClassName7.MODAL_BODY_CLASS,
      MODAL_CONTAINER_CLASS = _global$ClassName7.MODAL_CONTAINER_CLASS,
      MODAL_CONTAINER_CENTERED_CLASS = _global$ClassName7.MODAL_CONTAINER_CENTERED_CLASS,
      MODAL_CONTAINER_INVISIBLE_CLASS = _global$ClassName7.MODAL_CONTAINER_INVISIBLE_CLASS,
      MODAL_MASK_CLASS = _global$ClassName7.MODAL_MASK_CLASS,
      MODAL_MASK_INVISIBLE_CLASS = _global$ClassName7.MODAL_MASK_INVISIBLE_CLASS,
      DEFAULT_BTN_CLASS = _global$ClassName7.DEFAULT_BTN_CLASS,
      PRIMARY_BTN_CLASS = _global$ClassName7.PRIMARY_BTN_CLASS,
      MODAL_CONFIRM_CONTAINER_CLASS = _global$ClassName7.MODAL_CONFIRM_CONTAINER_CLASS,
      MODAL_INFO_CONTAINER_CLASS = _global$ClassName7.MODAL_INFO_CONTAINER_CLASS,
      MODAL_ERROR_CONTAINER_CLASS = _global$ClassName7.MODAL_ERROR_CONTAINER_CLASS,
      MODAL_SUCCESS_CONTAINER_CLASS = _global$ClassName7.MODAL_SUCCESS_CONTAINER_CLASS,
      MODAL_WARN_CONTAINER_CLASS = _global$ClassName7.MODAL_WARN_CONTAINER_CLASS,
      SPECIAL_MODAL_TITLE = _global$ClassName7.SPECIAL_MODAL_TITLE,
      SPECIAL_MODAL_CONTENT = _global$ClassName7.SPECIAL_MODAL_CONTENT,
  ...
  function Modal(options) {
    ...
    // 默认 footer
    var cancelText = isUndefined(options.cancelText) ? '取消' : options.cancelText;
    var cancelButtonProps = {};
    var cancelButtonClass = appendClass(DEFAULT_BTN_CLASS, MODAL_FOOTER_CANCEL_BTN_CLASS);

    var okText = isUndefined(options.okText) ? '确认' : options.okText;
    var okButtonProps = {};
    var okButtonClass = appendClass(DEFAULT_BTN_CLASS, PRIMARY_BTN_CLASS, MODAL_FOOTER_OK_BTN_CLASS);

    var cancelBtn = isNull(cancelText) ? '' : $.node('button', cancelText, cancelButtonClass, cancelButtonProps);
    var okBtn = isNull(okText) ? '' : $.node('button', okText, okButtonClass, okButtonProps);
  ...
  extend(Modal.prototype, {
    render: function render() {
      var _options11 = this.options,
          title = _options11.title,
          closable = _options11.closable,
          bodyContent = _options11.bodyContent,
          footer = _options11.footer,
          bodyStyle = _options11.bodyStyle,
          centered = _options11.centered,
          style = _options11.style,
          wrapClassName = _options11.wrapClassName,
          zIndex = _options11.zIndex,
          defaultVisible = _options11.defaultVisible;


      var closeDOM = '';
      if (closable) {
        var closeIcon = new Icon('close', { size: 20 }).html;
      ...
      if (isString(title) && title !== '') {
        var titleWrap = $.node('div', title + closeDOM, MODAL_HEADER_WRAP_CLASS);
        titleDOM = $.node('div', titleWrap, MODAL_HEADER_CONTAINER_CLASS);
      }

      var bodyContentDOM = $.node('div', bodyContent, MODAL_BODY_CLASS, {
    ...
    componentDidMount: function componentDidMount() {
      var isIncludeMask = this.isIncludeMask,
          isModalClosable = this.isModalClosable;
    ...
    bindEvents: function bindEvents() {
      var isModalClosable = this.isModalClosable,
          $modalCloseBtn = this.$modalCloseBtn,
          $cancelBtn = this.$cancelBtn,
          $okBtn = this.$okBtn,
          _options12 = this.options,
          afterClose = _options12.afterClose,
          onCancel = _options12.onCancel,
          onOk = _options12.onOk,
          keyboard = _options12.keyboard;
      ...
      var closeModalHandler = function closeModalHandler(e) {
        var key = e.key;
    ...
    handleMask: function handleMask(dom) {
      var _options13 = this.options,
          maskStyle = _options13.maskStyle,
          mask = _options13.mask,
          centered = _options13.centered,
          defaultVisible = _options13.defaultVisible;
      ...
      var klass = appendClass(MODAL_MASK_CLASS, this.RANDOM_CLASS + '_mask', centered ? MODAL_CONTAINER_CENTERED_CLASS : '', defaultVisible ? '' : MODAL_MASK_INVISIBLE_CLASS);
  ...
  Modal.method = function (type, options) {
    ...
    var icon = new Icon(type, { size: 22 }).html;
    var titleDOM = $.node('div', icon + $.node('span', title), SPECIAL_MODAL_TITLE);

    // modal content
    var contentDOM = $.node('div', content, SPECIAL_MODAL_CONTENT);
   ...
   */
  MODAL_TYPE_MAP.forEach(function (type) {
...
;!function (global, factory) {
  ...
  var Component = global.Component,
      $ = global.jQuery,
      _global$util8 = global.util,
      isFunction = _global$util8.isFunction,
      checkType = _global$util8.checkType,
      toSelector = _global$util8.toSelector,
      extend = _global$util8.extend,
      removeKeys = _global$util8.removeKeys,
      appendClass = _global$util8.appendClass,
      _global$ClassName8 = global.ClassName,
      PAGINATION_ITEM_CLASS = _global$ClassName8.PAGINATION_ITEM_CLASS,
      PAGINATION_ITEM_CLASS_ACTIVE = _global$ClassName8.PAGINATION_ITEM_CLASS_ACTIVE,
      PAGINATION_ITEM_CLASS_BORDER = _global$ClassName8.PAGINATION_ITEM_CLASS_BORDER,
      PAGINATION_ITEM_CLASS_DISABLE = _global$ClassName8.PAGINATION_ITEM_CLASS_DISABLE,
      PAGINATION_ITEM_CLASS_PREV = _global$ClassName8.PAGINATION_ITEM_CLASS_PREV,
      PAGINATION_ITEM_CLASS_NEXT = _global$ClassName8.PAGINATION_ITEM_CLASS_NEXT,
      PAGINATION_CONTAINER_CLASS = _global$ClassName8.PAGINATION_CONTAINER_CLASS,
      PAGINATION_ITEM_MORE_CLASS = _global$ClassName8.PAGINATION_ITEM_MORE_CLASS,
      PAGINATION_ITEM_NEXT_MORE_CLASS = _global$ClassName8.PAGINATION_ITEM_NEXT_MORE_CLASS,
      PAGINATION_ITEM_PREV_MORE_CLASS = _global$ClassName8.PAGINATION_ITEM_PREV_MORE_CLASS,
  ...
  extend(Pagination.prototype, {
    render: function render() {
      var selector = this.selector,
          _options14 = this.options,
          current = _options14.current,
          total = _options14.total,
          pageSize = _options14.pageSize;
    ...
    createPagination: function createPagination(page, isActive) {
      var _options15 = this.options,
          bordered = _options15.bordered,
          itemRender = _options15.itemRender;
    ...
    createPrevious: function createPrevious() {
      var _options16 = this.options,
          current = _options16.current,
          itemRender = _options16.itemRender,
          bordered = _options16.bordered;
    ...
    createNext: function createNext() {
      var _options17 = this.options,
          current = _options17.current,
          itemRender = _options17.itemRender,
          bordered = _options17.bordered,
...
;!function (global, factory) {
  ...
  var Component = global.Component,
      $ = global.jQuery,
      _global$util9 = global.util,
      isFunction = _global$util9.isFunction,
      isUndefined = _global$util9.isUndefined,
      isNil = _global$util9.isNil,
      toSelector = _global$util9.toSelector,
      extend = _global$util9.extend,
      removeKeys = _global$util9.removeKeys,
      appendClass = _global$util9.appendClass,
      _global$ClassName9 = global.ClassName,
      TAB_ITEM_CLASS = _global$ClassName9.TAB_ITEM_CLASS,
      TAB_ITEM_CLASS_ACTIVE = _global$ClassName9.TAB_ITEM_CLASS_ACTIVE,
      TAB_ITEM_CARD_CLASS = _global$ClassName9.TAB_ITEM_CARD_CLASS,
      TAB_ITEM_WRAP_CLASS = _global$ClassName9.TAB_ITEM_WRAP_CLASS,
      TAB_ITEM_INNER_CLASS = _global$ClassName9.TAB_ITEM_INNER_CLASS,
      TAB_ITEM_CARD_INNER_CALSS = _global$ClassName9.TAB_ITEM_CARD_INNER_CALSS,
      TAB_ITEM_CONTAINER_CLASS = _global$ClassName9.TAB_ITEM_CONTAINER_CLASS,
      TAB_ITEM_CONTAINER_WITH_ARROW_CLASS = _global$ClassName9.TAB_ITEM_CONTAINER_WITH_ARROW_CLASS,
      PANE_ITEM_CLASS = _global$ClassName9.PANE_ITEM_CLASS,
      PANE_ITEM_CLASS_ACTIVE = _global$ClassName9.PANE_ITEM_CLASS_ACTIVE,
      PANE_ITEM_WRAP_CLASS = _global$ClassName9.PANE_ITEM_WRAP_CLASS,
      TAB_ARROW_CLASS = _global$ClassName9.TAB_ARROW_CLASS,
      TAB_ARROW_CLASS_DISABLE = _global$ClassName9.TAB_ARROW_CLASS_DISABLE,
      TAB_ARROW_CLASS_INVISIBLE = _global$ClassName9.TAB_ARROW_CLASS_INVISIBLE,
      TAB_PREVIOUS_ARROW_CLASS = _global$ClassName9.TAB_PREVIOUS_ARROW_CLASS,
      TAB_NEXT_ARROW_CLASS = _global$ClassName9.TAB_NEXT_ARROW_CLASS,
      TAB_CONTAINER_CLASS = _global$ClassName9.TAB_CONTAINER_CLASS,
      UNDERLINE_CLASS = _global$ClassName9.UNDERLINE_CLASS,
      CLOSE_ICON_CLASS = _global$ClassName9.CLOSE_ICON_CLASS,
  ...
  extend(Tabs.prototype, {
    render: function render() {
      var $container = this.$container,
          _options18 = this.options,
          tabPanes = _options18.tabPanes,
          renderPaneItem = _options18.renderPaneItem,
          defaultKey = _options18.defaultKey,
          type = _options18.type,
          editable = _options18.editable;
    ...
    handleTabChange: function handleTabChange(current, index, isOnClose) {
      ...
      var unRenderPanes = this.unRenderPanes,
          ...
          $panes = this.$panes,
          containerWidth = this.containerWidth,
          _options19 = this.options,
          type = _options19.type,
          onChange = _options19.onChange,
          tabPanes = _options19.tabPanes;
      var $tabItems = this.$tabItems;
